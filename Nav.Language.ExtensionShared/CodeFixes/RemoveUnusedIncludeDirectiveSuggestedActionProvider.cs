...
/// <see cref="RemoveUnusedIncludeDirectiveSuggestedAction"/> für die aktuelle Editor-Selektion anbietet. Die
/// Fund-Logik liegt in der Engine (<see cref="RemoveUnusedIncludeDirectiveCodeFixProvider.SuggestCodeFixes"/>);
/// jeder gefundene <see cref="RemoveUnusedIncludeDirectiveCodeFix"/> wird in eine Lightbulb-Aktion verpackt.
/// </summary>
...
class RemoveUnusedIncludeDirectiveSuggestedActionProvider: CodeFixSuggestedActionProvider {
    ...
    /// jeden in eine <see cref="RemoveUnusedIncludeDirectiveSuggestedAction"/>.
    /// </summary>
