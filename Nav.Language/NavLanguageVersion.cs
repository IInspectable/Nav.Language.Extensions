...
public readonly struct NavLanguageVersion: IEquatable<NavLanguageVersion>, IComparable<NavLanguageVersion> {
    ...
    /// <summary>
    /// Die Version, die ohne <c>#pragma version</c> gilt — das historische Sprachverhalten (Version 1).
    /// </summary>
    public static NavLanguageVersion Default => new(1);

    /// <summary>Die höchste derzeit von der Engine unterstützte Sprach-Version.</summary>
    public static NavLanguageVersion Latest => new(1);
