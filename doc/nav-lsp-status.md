...
> **Nächste Session-Aufgabe:** **Korrektheit/Robustheit** — am wertvollsten die **dependency-aware
> Re-Diagnose** bei `didChange` (heute werden nur die Diagnostics der geänderten Datei neu publiziert,
> nicht die der inkludierenden); danach `workspace/didChangeWatchedFiles`, inkrementeller Doc-Sync,
> MessagePack-Pin. Alternativ der **Phase-3-Spike** (VS als RPC-Client). Die Completion ist vollständig
